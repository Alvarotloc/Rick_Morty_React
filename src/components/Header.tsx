...
const Header = ():JSX.Element => {
  return (
    <header className="w-full border-b-2 flex items-center justify-around fixed z-10 bg-gray-900/30 backdrop-blur h-24">
        <Link to="/" className="text-white text-3xl relative mr-96 transition-colors hover:text-pink-600">Inicio</Link>
        <img src="../../images/descarga.png" alt="Logo Rick y Morty" className="md:h-3/4 fixed "/>
